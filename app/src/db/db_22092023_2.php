...
INSERT INTO access_control (id, description, permission_create, permission_read, permission_update, permission_delete) VALUES (1, 'Controle Total', 'Y', 'Y', 'Y', 'Y');
INSERT INTO access_control (id, description, permission_create, permission_read, permission_update, permission_delete) VALUES (2, 'Apenas leitura',        'N', 'Y', 'N', 'N');
INSERT INTO access_control (id, description, permission_create, permission_read, permission_update, permission_delete) VALUES (3, 'Leitura e gravação',     'Y', 'Y', 'N', 'N');
...
CREATE TABLE users(
        ...
        deleted_at DATETIME,
        PRIMARY KEY (id),
        FOREIGN KEY (id_access_control) REFERENCES access_control(id)
    );
